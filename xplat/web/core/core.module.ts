...
export class DesktopStaterCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: DesktopStaterCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'DesktopStaterCoreModule');
  }
}
